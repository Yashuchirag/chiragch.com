export const Projects = [
  {
    ...
    responsibilities: [
      ...
      'Integrated a FastAPI backend processing pipeline using OpenCV for frame-level video analysis, YOLO11 for real-time player and shuttlecock detection, and TrackNet for high-accuracy shuttle trajectory tracking across rally sequences.',
    ...
    skills: ['React Native', 'Expo SDK 54', 'TypeScript', 'Expo Router', 'FastAPI', 'Python', 'OpenCV', 'YOLO11', 'TrackNet', 'Computer Vision', 'Machine Learning', 'Sports Analytics'],
